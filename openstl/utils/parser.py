...
def create_parser():
    ...
    parser.add_argument('--dataname', '-d', default='mmnist', type=str,
                        choices=['bair', 'mfmnist', 'mmnist', 'mmnist_cifar', 'noisymmnist', 'taxibj', 'rainfall', 'shanghai', 'human',
                                'kth', 'kth20', 'kth40', 'kitticaltech', 'kinetics', 'kinetics400', 'kinetics600', 'PV',
    ...
    parser.add_argument('--method', '-m', default='SimVP', type=str,
                        choices=['ConvLSTM', 'convlstm', 'E3DLSTM', 'e3dlstm', 'MAU', 'mau', 'MIM', 'mim', 
                                ...
                                'SwinLSTM', 'swinlstm', 'swinlstm_d', 'swinlstm_b', 'motionrnn', 'MotionRNN',
                                 'GMG'],
